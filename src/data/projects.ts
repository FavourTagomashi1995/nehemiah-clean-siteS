...
export const projects: Project[] = [
  {
    ...
    phases: [
      {
        ...
        description:
          "Register or incorporate 10 existing Farmers Primary Cooperative Societies, each with 15 members, to form one Cooperative Union.",
      },
      {
        title: "Phase II: Establishment of Cooperative Unions",
        description:
          "Establish one Cooperative Union in each of the three senatorial zones in each of the six states under the six regional state offices.",
      },
      {
        title: "Phase III: State-Level Apex Cooperatives",
        description:
          "Consolidate the 30 Cooperative Unions in a state to form one state-level Cooperative Apex in each of the six geopolitical zones.",
      },
      {
        title: "Phase IV: National Cooperative Federation",
        description:
          "Replicate the model in all 36 states and Abuja, forming a national Cooperative Federation consisting of the 37 state-level Apex cooperatives.",
      },
      {
        title: "Phase V: Membership Expansion",
        description:
          "Scale to 16,650 members nationwide by the fifth year: 450 members x 37 states.",
      },
    ],
    ...
    regionalOffices: [
      ...
      { region: "North East", location: "Gombe" },
      { region: "South East", location: "Owerri" },
      { region: "North West", location: "Kaduna" },
      { region: "South West", location: "Ibadan" },
      { region: "South South", location: "Uyo" },
      { region: "North Central", location: "Benue" },
    ],
